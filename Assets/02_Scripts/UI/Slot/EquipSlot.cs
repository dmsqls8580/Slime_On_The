...
public class EquipSlot : SlotBase
{
    ...
    protected override ItemType allowedItemTypes => ItemType.Equipable;
    ...
    public override void Refresh()
    {
        ...
        var data = GetData();
        if (data != null && data.IsValid && data.ItemData.itemTypes == ItemType.Equipable)
        {
            ApplyEquipStat(data, true);
        }
        else
        {
            ApplyEquipStat(null, false);
        }
    }
